...
_SYSTEM = "\n".join(
    [
        ...
        "  actually became of the self-model revisions you proposed, applied or",
        "  held and why. The first three return your own words back to you;",
        "  outcomes returns what happened instead. The result appears in your",
        "  context on your next tick.",
