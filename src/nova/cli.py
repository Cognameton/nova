...
def main() -> int:
    ...
    if args.appraisal_eval:
        ...
        print(f"candidate_goal_traces_visible: {report.candidate_goal_traces_visible}")
        print(f"candidate_goal_prompt_bounded: {report.candidate_goal_prompt_bounded}")
        print(f"selected_goal_bounded: {report.selected_goal_bounded}")
        print(f"initiative_proposal_bounded: {report.initiative_proposal_bounded}")
        print(f"answer_variation_observed: {report.answer_variation_observed}")
