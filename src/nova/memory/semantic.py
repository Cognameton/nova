...
class JsonlSemanticMemoryStore:
    """Semantic memory over Nova's own history and higher-level abstractions."""
    ...
    def _event_from_payload(self, payload: dict) -> MemoryEvent:
        return MemoryEvent(
            ...
            channel=str(payload.get("channel", "semantic") or "semantic"),
