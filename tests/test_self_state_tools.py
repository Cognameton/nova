...
class SelfStateToolSpecTests(unittest.TestCase):
    ...
    def test_self_state_tool_names_constant_has_ten_entries(self):
        # Five Phase 18/19 inward tools + two Phase 21 exploration tools
        # + recall_history (22.10) + play_reversi (22.13) + read_instructions (22.17).
        self.assertEqual(len(SELF_STATE_TOOL_NAMES), 10)
